...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    desc: '안 쓰는 체크리스트는 숨기고, 출산가방·100일 준비 같은 준비물 팩은 필요할 때 추가로 켤 수 있어요. 설정 탭 → 체크리스트 관리에서 언제든 바꿀 수 있어요.',
  },
  {
    icon: 'playlist_add',
    bg: '#DCF3E4',
...
function renderTutorialStep() {
  ...
  body.innerHTML = `
    <div class="tut-icon" style="background:${s.bg}">
      <span class="icon" translate="no" aria-hidden="true">${s.icon}</span>
    </div>
