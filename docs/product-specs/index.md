...
| [`play-store-launch.md`](./play-store-launch.md) | 플레이스토어 출시 — PWA를 TWA로 패키징, 서명 키, Android 개발자 인증, 비공개 테스트 요건, 스토어 등록정보 | 🟡 진행 중 — TWA 패키지 생성·assetlinks.json 배포 완료, 서명 키 백업 확인 대기 |
