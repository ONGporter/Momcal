...
| [`kakao-login.md`](./kakao-login.md) | 카카오 로그인 — Cloud Function으로 Kakao access token을 Firebase 커스텀 토큰으로 교환, uid 네임스페이스 설계, 알려진 제약(이메일 미수집·계정 미연결) | 🟡 코드 구현 + JavaScript 키 반영 완료 · Cloud Functions 배포 대기 |
